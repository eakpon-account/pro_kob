...
## 🔐 ข้อมูลบัญชีผู้ใช้งานระบบ (Default Credentials)

เพื่อความปลอดภัยของข้อมูล ระบบกำหนดให้ต้อง **เข้าสู่ระบบก่อนเริ่มใช้งาน (Authentication Gate)**

| บทบาท (Role) | ชื่อผู้ใช้ (Username) / อีเมล | รหัสผ่าน (Password) | สิทธิ์การใช้งาน |
| :--- | :--- | :--- | :--- |
| 🛡️ **ผู้ดูแลระบบ (Admin)** | `admin` หรือ `admin@school.ac.th` | **`213894120`** | จัดการทุกส่วนของระบบ, ผู้ใช้, ฐานข้อมูล, รายวิชา, ทะเบียนนักเรียน |
| 👨‍🏫 **ครูประจำวิชา (Teacher)** | `pimpa.n` หรือ `teacher` | `password123` | จัดการรายวิชาที่สอน, เช็คชื่อ, กรอกคะแนน, พิมพ์รายงาน ปพ.5 |
| 📋 **ฝ่ายทะเบียน (Staff)** | `somchai.s` หรือ `staff` | `password123` | นำเข้านักเรียน, ดูสถิติและภาพรวมผลการศึกษา |
| 👁️ **ผู้เยี่ยมชม (Guest)** | `guest` | `password123` | ดูภาพรวมและรายงานในโหมดอ่านอย่างเดียว (Read-only) |

> 💡 **หมายเหตุ:** สามารถเปลี่ยนรหัสผ่านและเพิ่มผู้ใช้งานใหม่ได้ตลอดเวลาที่เมนู **ตั้งค่าระบบ > ผู้ใช้งาน & สิทธิ์**
